...
export const momentToDayFormat = (date: Moment, isLikeMoment = false): Moment => {
  return isLikeMoment ? moment(date.format('YYYY-MM-DD')) : moment(date.format('YYYY-MM-DD'))
}

export const dateToDayFormat = (date: Date, isLikeMoment = false): Moment => {
  return isLikeMoment
